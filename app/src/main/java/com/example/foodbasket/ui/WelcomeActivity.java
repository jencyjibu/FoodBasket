...
import com.example.foodbasket.util.PrefManager;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(WelcomeActivity.this, BuyOrSell.class));
        finish();
    }
    private void launchRegistrationScreen() {
        startActivity(new Intent(WelcomeActivity.this, PersonalDetailsRegistration.class));
    }
